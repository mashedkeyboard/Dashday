...
def start():
    ...
    main.start()
    serv.updateScheduledRun(dashdayjob.next_run.strftime("%dd/%mm/%yyyy %H:%M:%S"))
    print("Dashday completed, next scheduled launch is at " + dashdayjob.next_run.strftime("%dd/%mm/%yyyy %H:%M:%S"))
...
def runapp():
    ...
    print("Dashday service running, next scheduled launch is at " + dashdayjob.next_run.strftime("%dd/%mm/%yyyy %H:%M:%S"))
    while True:
